...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Aston Martin Vulcan : (Rs  15.04 Cr*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/vu-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/vu-2.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/vu-3.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/vu-4.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/vu-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/vu-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/vu-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/vu-4.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
							<table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Mileage	7.0 kmpl</td>
                                           <td>Engine	6996 cc</td>
                                       ...
                                       <tr>
                                           <td>Service Cost: Rs 85,973/yr</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">VULCAN highlights</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    The Aston Martin Vulcan is a two-door, two-seater, V12 high-performance lightweight track-only limited edition car launched in 2015 by Aston Martin at the 2015 Geneva Motor Show. Its engine, mounted in an aluminium alloy chassis with a carbon fibre body, delivers 804 brake horsepower (600 kW). The Vulcan is fitted with carbon ceramic brakes, magnesium torque tube with a carbon fibre propeller shaft, limited-slip differential, Xtrac 6-speed sequential gearbox and has a curb weight of 1,350 kg (2,980 lb).
