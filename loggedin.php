		   ...
		   <div class="box_wrapper"><h1>Car Brands </h1></div>
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="toyota.html" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="audi.html" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="bmw.html" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="grid_desc">
						<p class="title">CHERVOLET</p>
					</div>
					<div class="Details">
				     <a href="chervolet.html" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
...
<div>
    <a href="" style="border: 1px black solid; margin-left: 65px;"> <b>Click here for more brands ...</b></a>
</div>
